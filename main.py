...
tools = [
    {"name":"Task Organizer",  "imageArea": "Images/TaskOrganizer.png", "button_text": "Link/Source1"},
    {"name":"Portfolio Site",  "imageArea": "Images/portfolioimage.png", "button_text": "Link/Source2"},
    {"name":"Games",  "imageArea": "Images/Games.png", "button_text": "Link/Source3"},
    {"name":"PDF Generator",  "imageArea": "Images/PDF_Generator_API.png", "button_text": "Link/Source4"}
]
...
projects = [
    {"name": "NBA Predictor", "imageArea": "Images/NBA_Analytics.png","button_text": "Link/Source5"},
...
for i, project in enumerate(projects):
    with proj_cols[i]:
        ...
        st.image(f"{project['imageArea']}", width=200)
